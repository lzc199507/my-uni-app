...
Z(z[3])
Z([3,'btn'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handleOk']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'true'])
Z([3,'primary'])
Z([3,'确定'])
Z([[7],[3,'isChooseBoy']])
...
Z(z[6])
Z([3,'a-item'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handleOpenModal']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'注册账号'])
Z([3,'|'])
Z([3,'../pwd/pwd'])
Z([3,'忘记密码'])
...
Z([3,'content'])
Z([3,'uni-header-logo'])
Z([3,'uni-header-image home'])
Z([3,'/static/img/welcome.jpg'])
Z([[7],[3,'hasLogin']])
Z([3,'hello'])
Z([3,'title'])
...
var xQ=_mz(z,'form',['bindreset',3,'bindsubmit',1,'data-event-opts',2],[],e,s,gg)
var fS=_n('view')
...
_(oV,cW)
_(hU,oV)
var oX=_mz(z,'switch',['bindchange',11,'checked',1,'data-event-opts',2,'name',3],[],e,s,gg)
_(hU,oX)
_(cT,hU)
_(fS,cT)
_(xQ,fS)
...
_(e2,b3)
_(t1,e2)
var o4=_mz(z,'input',['bindinput',19,'class',1,'data-event-opts',2,'name',3,'placeholder',4],[],e,s,gg)
_(t1,o4)
_(lY,t1)
var x5=_n('view')
...
var lCB=_mz(z,'picker',['bindchange',32,'data-event-opts',1,'name',2,'range',3,'rangeKey',4,'value',5],[],e,s,gg)
var aDB=_n('view')
...
var bGB=_mz(z,'button',['bindtap',41,'class',1,'data-event-opts',2,'plain',3,'type',4],[],e,s,gg)
...
_(fKB,cLB)
_(oJB,fKB)
var hMB=_n('radio-group')
_rz(z,hMB,'name',51,e,s,gg)
var oNB=_v()
_(hMB,oNB)
if(_oz(z,52,e,s,gg)){oNB.wxVkey=1
var cOB=_n('label')
var oPB=_n('radio')
_rz(z,oPB,'value',53,e,s,gg)
_(cOB,oPB)
var lQB=_n('text')
...
_(o2B,c3B)
_(h1B,o2B)
var o4B=_n('radio-group')
_rz(z,o4B,'name',62,e,s,gg)
var l5B=_n('label')
var a6B=_n('radio')
_rz(z,a6B,'value',63,e,s,gg)
_(l5B,a6B)
var t7B=_n('text')
...
var oHC=_n('view')
_rz(z,oHC,'class',70,e,s,gg)
var lIC=_oz(z,71,e,s,gg)
_(oHC,lIC)
_(cGC,oHC)
var aJC=_n('radio-group')
_rz(z,aJC,'name',72,e,s,gg)
var tKC=_n('label')
var eLC=_n('radio')
_rz(z,eLC,'value',73,e,s,gg)
_(tKC,eLC)
var bMC=_n('text')
var oNC=_oz(z,74,e,s,gg)
_(bMC,oNC)
_(tKC,bMC)
_(aJC,tKC)
var xOC=_n('label')
var oPC=_n('radio')
_rz(z,oPC,'value',75,e,s,gg)
_(xOC,oPC)
var fQC=_n('text')
...
_rz(z,eZC,'name',82,e,s,gg)
var b1C=_n('label')
var o2C=_n('checkbox')
_rz(z,o2C,'value',83,e,s,gg)
_(b1C,o2C)
var x3C=_n('text')
var o4C=_oz(z,84,e,s,gg)
_(x3C,o4C)
_(b1C,x3C)
_(eZC,b1C)
var f5C=_n('label')
var c6C=_n('checkbox')
_rz(z,c6C,'value',85,e,s,gg)
_(f5C,c6C)
var h7C=_n('text')
var o8C=_oz(z,86,e,s,gg)
_(h7C,o8C)
_(f5C,h7C)
_(eZC,f5C)
_(lWC,eZC)
_(xIB,lWC)
var c9C=_n('view')
_rz(z,c9C,'class',87,e,s,gg)
var o0C=_n('view')
_rz(z,o0C,'class',88,e,s,gg)
var lAD=_oz(z,89,e,s,gg)
_(o0C,lAD)
_(c9C,o0C)
var aBD=_mz(z,'slider',['showValue',-1,'name',90,'value',1],[],e,s,gg)
_(c9C,aBD)
_(xIB,c9C)
var tCD=_n('view')
_rz(z,tCD,'class',92,e,s,gg)
var eDD=_n('view')
_rz(z,eDD,'class',93,e,s,gg)
var bED=_oz(z,94,e,s,gg)
_(eDD,bED)
_(tCD,eDD)
var oFD=_mz(z,'input',['class',95,'name',1,'placeholder',2],[],e,s,gg)
_(tCD,oFD)
_(xIB,tCD)
var xGD=_n('view')
_rz(z,xGD,'class',98,e,s,gg)
var oHD=_n('button')
_rz(z,oHD,'formType',99,e,s,gg)
var fID=_oz(z,100,e,s,gg)
_(oHD,fID)
_(xGD,oHD)
var cJD=_mz(z,'button',['formType',101,'type',1],[],e,s,gg)
var hKD=_oz(z,103,e,s,gg)
_(cJD,hKD)
_(xGD,cJD)
_(xIB,xGD)
_(aZ,xIB)
...
_(tQD,eRD)
_(aPD,tQD)
var bSD=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',5,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(aPD,bSD)
_(lOD,aPD)
var oTD=_n('view')
...
var o2D=_mz(z,'text',['bindtap',30,'class',1,'data-event-opts',2],[],e,s,gg)
...
var o8D=_mz(z,'view',['class',38,'style',1],[],e,s,gg)
var x9D=_v()
_(o8D,x9D)
var o0D=function(cBE,fAE,hCE,gg){
var cEE=_n('view')
_rz(z,cEE,'class',44,cBE,fAE,gg)
var oFE=_mz(z,'image',['bindtap',45,'data-event-opts',1,'src',2],[],cBE,fAE,gg)
_(cEE,oFE)
_(hCE,cEE)
return hCE
}
x9D.wxXCkey=2
_2z(z,42,o0D,e,s,gg,x9D,'provider','__i0__','value')
_(oND,o8D)
}
oND.wxXCkey=1
_(r,cMD)
...
var oLE=_mz(z,'image',['class',2,'src',1],[],e,s,gg)
_(bKE,oLE)
_(aHE,bKE)
var tIE=_v()
_(aHE,tIE)
...
_(c7E,o8E)
_(o6E,c7E)
var l9E=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',5,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(o6E,l9E)
_(h5E,o6E)
_(c4E,h5E)
var a0E=_n('view')
_rz(z,a0E,'class',12,e,s,gg)
var tAF=_mz(z,'button',['bindtap',13,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
_(fGF,cHF)
_(oFF,fGF)
var hIF=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',5,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(oFF,hIF)
_(xEF,oFF)
var oJF=_n('view')
...
_(cKF,oLF)
_(oJF,cKF)
var lMF=_mz(z,'m-input',['displayable',-1,'bind:__l',15,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(oJF,lMF)
_(xEF,oJF)
var aNF=_n('view')
...
_(tOF,ePF)
_(aNF,tOF)
var bQF=_mz(z,'m-input',['clearable',-1,'bind:__l',25,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(aNF,bQF)
_(xEF,aNF)
_(oDF,xEF)
var oRF=_n('view')
var xSF=_n('checkbox-group')
var oTF=_n('label')
var fUF=_mz(z,'checkbox',['checked',32,'value',1],[],e,s,gg)
_(oTF,fUF)
...
var l1F=_mz(z,'button',['bindtap',38,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var o8F=_mz(z,'button',['bindtap',3,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var c0F=_mz(z,'button',['bindtap',9,'data-event-opts',1,'type',2],[],e,s,gg)
